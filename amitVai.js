    ...
    // }
        ...
        let pendingModifications = {}; // Store modifications temporarily
        ...
        async function saveModifications(elementId, css, elementStructure = null) {
            ...
            // Store changes in memory instead of sending them immediately
            ...
            console.log("📝 Changes saved temporarily:", pendingModifications);
        }
