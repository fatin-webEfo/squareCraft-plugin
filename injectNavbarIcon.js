export function injectNavbarIcon() {
    function insertAdminIcon() {
        const isInstalled = localStorage.getItem("squareCraft_installed");
        const sessionCheck = sessionStorage.getItem("squareCraft_active");
    
        if (!sessionCheck) {
            sessionStorage.setItem("squareCraft_active", "true");
