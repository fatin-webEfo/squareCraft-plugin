         ...
         <div class="">
            ...
            <div class="squareCraft-flex  squareCraft-mt-2 squareCraft-px-2">
               ...
               <div id="heading1"
                  ...
                  <div class="squareCraft-active-bar squareCraft-rounded-l"></div>
               ...
               <div class="squareCraft-mt-2 squareCraft-px-2  squareCraft-gap-2">
                  ...
                  <div
                     ...
                     <div class="squareCraft-flex squareCraft-items-center squareCraft-justify-between  ">
                        <div class="squareCraft-px-2 squareCraft-py-1px squareCraft-inActiveTab-border squareCraft-cursor-pointer squareCraft-rounded-l">
              ...
              <div class="squareCraft-mt-2 squareCraft-px-2">
               ...
               <div
                  ...
                  <div class="squareCraft-col-span-5 squareCraft-bg-3f3f3f squareCraft-inActiveTab-border squareCraft-flex squareCraft-justify-between squareCraft-items-center squareCraft-px-2 squareCraft-rounded-6px">
                     <p id="textcolorHtml" class="squareCraft-text-sm squareCraft-poppins squareCraft-universal">Select</p>
               ...
               <div
                  ...
                  <div
                    ...
                    <div
                        ...
                        <div id="squareCraftTextAlignJustify" data-align="justify" class="squareCraft-pt-1 squareCraft-pb-1 squareCraft-px-1_5 squareCraft-inActiveTab-border squareCraft-cursor-pointer squareCraft-rounded-l">
                        ...
                        <div id="squareCraftTextAlignCenter" data-align="center" class="squareCraft-pt-1 squareCraft-pb-1 squareCraft-px-1_5 squareCraft-inActiveTab-border squareCraft-cursor-pointer ">

                           <img 
                              src="https://fatin-webefo.github.io/squareCraft-plugin/public/alignment (3).svg"
                              class=" alignment-icon   squareCraft-mx-auto" alt="justify">
                        </div>
                        <div id="squareCraftTextAlignRight" data-align="right" class="squareCraft-pt-1 squareCraft-pb-1 squareCraft-px-1_5 squareCraft-inActiveTab-border squareCraft-cursor-pointer">

                           <img 
                              src="https://fatin-webefo.github.io/squareCraft-plugin/public/alignment (2).svg"
                              class=" alignment-icon   squareCraft-mx-auto" alt="justify">
                        </div>
                        <div id="squareCraftTextAlignLeft" data-align="left" class="squareCraft-pt-1 squareCraft-pb-1 squareCraft-px-1_5 squareCraft-inActiveTab-border squareCraft-cursor-pointer squareCraft-rounded-r">
