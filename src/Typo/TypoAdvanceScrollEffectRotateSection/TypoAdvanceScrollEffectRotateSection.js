export function TypoAdvanceScrollEffectRotateSection() {
  return `
     <div
         id="Typo-advance-rotate-section"
         ...
         <div class="sc-flex sc-flex-col sc-gap-2">
           <div class="sc-flex sc-gap-2 sc-items-center">
             ...
             <div
               id="Typo-rotate-custom-timeline-reset"
           ...
           >
             <p class="sc-universal sc-roboto">
               Start <span id="Typo-rotate-timelineStartValue">0%</span>
             </p>
             <p class="sc-universal sc-roboto">
               End <span id="Typo-rotate-timelineEndValue">0%</span>
             </p>
           </div>
           <div
             id="Typo-rotate-custom-timeline-border"
             class="sc-mt-1 rotate-custom-timeline-border"
           >
             <div
               id="Typo-rotate-custom-timeline-arrow"
         ...
         <div class="sc-w-full sc-mt-8">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-rotate-advance-entry-count"
               ...
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-rotate-advance-entry-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-rotate-advance-entry-decrease"
           ...
           >
             ...
             ></div>
             <div
               id="Typo-rotate-advance-entry-bullet"
         ...
         <div class="sc-w-full sc-mt-3">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-rotate-advance-center-count"
                 class="sc-font-thin sc-roboto sc-universal sc-font-size-11"
               >
                 0px
               </p>
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-rotate-advance-center-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-rotate-advance-center-decrease"
                   class="sc-arrow-placeholder sc-rotate-180"
                 ></span>
               </div>
             </div>
           ...
           >
             ...
             ></div>
             <div
               id="Typo-rotate-advance-center-bullet"
               class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
             ></div>
           </div>
         </div>
         <div class="sc-w-full sc-mt-3">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-rotate-advance-exit-count"
                 class="sc-font-thin sc-roboto sc-universal sc-font-size-11"
               >
                 0px
               </p>
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-rotate-advance-exit-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-rotate-advance-exit-decrease"
                   class="sc-arrow-placeholder sc-rotate-180"
                 ></span>
               </div>
             </div>
           ...
           >
             ...
             ></div>
             <div
               id="Typo-rotate-advance-exit-bullet"
               class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
             ></div>
           </div>
         </div>
         ...
         <div class="sc-mt-6 sc-z-99999">
           ...
           <div
             ...
             id="Typo-rotate-effect-animation-dropdown-container"
           >
             <div
               class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-2 sc-w-full"
             >
               <p
                 id="Typo-rotate-effect-animation-value"
             ...
             <div
               id="Typo-rotate-effect-animation-type-arrow"
             ...
             <div
               id="Typo-rotate-effect-animation-type-list"
