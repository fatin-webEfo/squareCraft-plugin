export function TypoAdvanceScrollEffectBlurSection() {
  return `
     <div
         id="Typo-advance-blur-section"
       ...
       >
         <div class="sc-flex sc-flex-col sc-gap-2">
           <div class="sc-flex sc-gap-2 sc-items-center">
             ...
             <div
               id="Typo-blur-custom-timeline-reset"
           ...
           >
             <p class="sc-universal sc-roboto">
               Start <span id="Typo-blur-timelineStartValue">0%</span>
             </p>
             <p class="sc-universal sc-roboto">
               End <span id="Typo-blur-timelineEndValue">0%</span>
             </p>
           </div>
           <div
             id="Typo-blur-custom-timeline-border"
             class="sc-mt-1 blur-custom-timeline-border"
           >
             <div
               id="Typo-blur-custom-timeline-arrow"
         ...
         <div class="sc-w-full sc-mt-8">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-blur-advance-entry-count"
               ...
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-blur-advance-entry-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-blur-advance-entry-decrease"
           ...
           <div
             id="Typo-blur-advance-entry-field"
             class="sc-rounded-15px sc-relative sc-mt-2 sc-w-full sc-h-2 sc-bg-F6F6F6"
           >
             <div
               id="Typo-blur-advance-entry-fill"
               class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"
             ></div>
             <div
               id="Typo-blur-advance-entry-bullet"
         ...
         <div class="sc-w-full sc-mt-3">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-blur-advance-center-count"
                 class="sc-font-thin sc-roboto sc-universal sc-font-size-11"
               >
                 0px
               </p>
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-blur-advance-center-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-blur-advance-center-decrease"
                   class="sc-arrow-placeholder sc-rotate-180"
                 ></span>
               </div>
             </div>
           ...
           <div
             id="Typo-blur-advance-center-field"
             class="sc-rounded-15px sc-relative sc-mt-2 sc-w-full sc-h-2 sc-bg-F6F6F6"
           >
             <div
               id="Typo-blur-advance-center-fill"
               class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"
             ></div>
             <div
               id="Typo-blur-advance-center-bullet"
               class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
             ></div>
           </div>
         </div>
         <div class="sc-w-full sc-mt-3">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-blur-advance-exit-count"
                 class="sc-font-thin sc-roboto sc-universal sc-font-size-11"
               >
                 0px
               </p>
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-blur-advance-exit-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-blur-advance-exit-decrease"
                   class="sc-arrow-placeholder sc-rotate-180"
                 ></span>
               </div>
             </div>
           ...
           <div
             id="Typo-blur-advance-exit-field"
             class="sc-rounded-15px sc-relative sc-mt-2 sc-w-full sc-h-2 sc-bg-F6F6F6"
           >
             <div
               id="Typo-blur-advance-exit-fill"
               class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"
             ></div>
             <div
               id="Typo-blur-advance-exit-bullet"
               class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
             ></div>
           </div>
         </div>
         ...
         <div class="sc-mt-6 sc-z-99999">
           ...
           <div
             ...
             id="Typo-blur-effect-animation-dropdown-container"
           >
             <div
               class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-2 sc-w-full"
             >
               <p
                 id="Typo-blur-effect-animation-value"
             ...
             <div
               id="Typo-blur-effect-animation-type-arrow"
             ...
             <div
               id="Typo-blur-effect-animation-type-list"
