export function TypoAdvanceScrollEffectScaleSection() {
  return `
    <div
         id="Typo-advance-scale-section"
       ...
       >
         <div class="sc-flex sc-flex-col sc-gap-2">
           <div class="sc-flex sc-gap-2 sc-items-center">
             ...
             <div
               id="Typo-scale-custom-timeline-reset"
           ...
           >
             <p class="sc-universal sc-roboto">
               Start <span id="Typo-scale-timelineStartValue">0%</span>
             </p>
             <p class="sc-universal sc-roboto">
               End <span id="Typo-scale-timelineEndValue">0%</span>
             </p>
           </div>
           <div
             id="Typo-scale-custom-timeline-border"
             class="sc-mt-1 scale-custom-timeline-border"
           >
             <div
               id="Typo-scale-custom-timeline-arrow"
         ...
         <div class="sc-w-full sc-mt-8">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-scale-advance-entry-count"
               ...
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-scale-advance-entry-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-scale-advance-entry-decrease"
           ...
           >
             ...
             ></div>
             <div
               id="Typo-scale-advance-entry-bullet"
         ...
         <div class="sc-w-full sc-mt-3">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-scale-advance-center-count"
                 class="sc-font-thin sc-roboto sc-universal sc-font-size-11"
               >
                 0px
               </p>
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-scale-advance-center-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-scale-advance-center-decrease"
                   class="sc-arrow-placeholder sc-rotate-180"
                 ></span>
               </div>
             </div>
           ...
           >
             ...
             ></div>
             <div
               id="Typo-scale-advance-center-bullet"
               class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
             ></div>
           </div>
         </div>
         <div class="sc-w-full sc-mt-3">
           <div class="sc-flex sc-w-full sc-items-center sc-justify-between">
             ...
             >
               <p
                 id="Typo-scale-advance-exit-count"
                 class="sc-font-thin sc-roboto sc-universal sc-font-size-11"
               >
                 0px
               </p>
               <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                 <span
                   id="Typo-scale-advance-exit-increase"
                   class="sc-arrow-placeholder"
                 ></span>
                 <span
                   id="Typo-scale-advance-exit-decrease"
                   class="sc-arrow-placeholder sc-rotate-180"
                 ></span>
               </div>
             </div>
           ...
           >
             ...
             ></div>
             <div
               id="Typo-scale-advance-exit-bullet"
               class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
             ></div>
           </div>
         </div>
         ...
         <div class="sc-mt-6 sc-z-99999">
           ...
           <div
             ...
             id="Typo-scale-effect-animation-dropdown-container"
           >
             <div
               class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-2 sc-w-full"
             >
               <p
                 id="Typo-scale-effect-animation-value"
             ...
             <div
               id="Typo-scale-effect-animation-type-arrow"
             ...
             <div
               id="Typo-scale-effect-animation-type-list"
