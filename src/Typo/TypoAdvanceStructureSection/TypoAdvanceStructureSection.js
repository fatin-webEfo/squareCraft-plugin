  ...
  <div  class="">
    ...
    >
      <div class="sc-relative sc-mt-2 sc-items-center sc-flex-col">
        <p  id="Typo-structure-margin-top-count"
      ...
      <div class="sc-flex sc-items-center sc-justify-center sc-gap-2">
        <div class="sc-flex sc-items-center sc-relative">
          <p  id="Typo-structure-margin-left-count"
            class="sc-universal sc-text-sm sc-text-gray-300 sc-font-thin sc-absolute"
            style="right: 30px"
          >
            0px
        ...
        <div class="Typo-structure-allside-box sc-relative sc-bg-454545">
          <img
            ...
            alt=""
          />
          <p  id="Typo-structure-padding-right-count"
            class="sc-universal sc-text-sm sc-text-gray-300 sc-font-thin sc-absolute"
            style="right: 18px"
          >
            0px
          </p>
          <p id="Typo-structure-padding-top-count"
            class="sc-universal sc-text-sm sc-text-gray-300 sc-font-thin sc-absolute"
            style="top: 18px"
          >
            0px
          </p>
          <p id="Typo-structure-padding-left-count"
            class="sc-universal sc-text-sm sc-text-gray-300 sc-font-thin sc-absolute"
            style="left: 18px"
          >
            0px
          </p>
          <p id="Typo-structure-padding-bottom-count"
            class="sc-universal sc-text-sm sc-text-gray-300 sc-font-thin sc-absolute"
            style="bottom: 18px"
          >
            0px
      ...
      <div class="sc-relative sc-items-center sc-flex-col">
        ...
        <p  id="Typo-structure-margin-bottom-count"
          class="sc-universal sc-text-sm sc-text-gray-300 sc-font-thin sc-absolute"
          style="top: 30px"
        >
          0px
