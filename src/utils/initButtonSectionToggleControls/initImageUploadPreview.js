    ...
    if (file && selectedElement) {
      ...
      reader.onload = function (e) {
        ...
        buttons.forEach(buttonLink => {
          ...
          clonedIcon.classList.add("sqscraft-button-icon");
          clonedIcon.style.height = "1em";
          clonedIcon.style.width = "auto";
          clonedIcon.style.maxHeight = "20px";
          clonedIcon.style.objectFit = "contain";
