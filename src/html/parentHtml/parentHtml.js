...
export function parentHtml() {
    ...
    return `
            ...
            <div
                ...
                <p class="sc-font-size-12 sc-mt-6 sc-font-light">Lorem Ipsum is simply dummy text
                    of the printing and typesetting industry.</p>
                <div
                    class="sc-mt-6  sc-border-t sc-border-dashed sc-border-color-494949  sc-w-full">
                </div>

                <div class="sc-mt-6 sc-flex  sc-items-center ">
                ...
                <div
                    class="sc-border-t sc-border-solid sc-relative sc-border-color-494949 sc-w-full sc-mt-2">
                    <div
                ...
                <div
                    ...
                    <div class="sc-mt-6 sc-px-2 sc-flex sc-justify-between">
                        <p class="sc-font-size-12">Text</p>
                        ...
                        <div  id="font-size" class="sc-flex sc-relative sc-cursor-pointer sc-relative sc-justify-between sc-col-span-4  sc-rounded-6px sc-border sc-border-solid sc-border-585858 sc-items-center sc-h-full">
                           <div class="sc-flex sc-items-center sc-w-full">
                            ...
                            <div class="sc-bg-494949  sc-px-1 sc-w-full sc-py-1px ">
                                <p class="sc-font-size-12 sc-font-light">px</p>
                            </div>
                           </div>
...
<div id="sc-bg-color-picker" class="sc-bg-color-2c2c2c sc-mt-2 sc-rounded-6px  sc-border sc-border-solid sc-border-585858 sc-w-full" style="z-index: 9999; position: relative;">
    <div class="sc-flex sc-p-2 sc-items-center sc-justify-between">
        <div class="sc-flex sc-gap-2 sc-items-center">
            ...
            <p class="sc-font-size-12">Background Color</p>
        </div>
