export function HoverTypoBoldSelect(LetterSpacing) {
  return `
          <div  class="sc-mt-2 sc-text-color-white">
            <div id="typo-bold-hover-font-button"
            ...
            <div id="typo-bold-hover-font-section"
            ...
            <div>
              <div id="typo-bold-hover-border-button"
              ...
              <div id="typo-bold-hover-border-section" class="sc-hidden sc-mt-2">
                 <div class=" sc-flex sc-items-center sc-justify-between">
                    ...
                    <div class="sc-col-span-5">
                       ...
                       <div
                          ...
                          <div 
                             ...
                             <div class="sc-flex sc-items-center sc-justify-between">
                                <div class="sc-flex sc-relative sc-items-center sc-gap-1">
                             ...
                             <div
                                class="sc-flex sc-justify-between sc-mt-2 sc-px-2 sc-py-0_5 sc-rounded-4px sc-bg-454545">
                                <p  class="sc-font-size-12 sc-roboto sc-font-light sc-universal">Select
                                </p>
                                <p 
           ...
           <div id="typo-bold-hover-shadow-button"
          class="sc-bg-3f3f3f sc-mt-2 sc-relative sc-z-9999 sc-flex sc-border-hover-3d3d3d sc-border sc-border-solid sc-border-3f3f3f sc-cursor-pointer sc-px-2 sc-justify-between sc-py-1 sc-rounded-4px">
          <p class="sc-roboto  sc-universal sc-font-size-14">Shadow</p>
          <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg"
             class="sc-rotate-180" alt="">
       </div>
       <div id="typo-bold-hover-shadow-section" class="sc-hidden">
       ...
       <div  id="typo-bold-hover-effects-button"
      ...
      <div id="typo-bold-hover-effects-section" class="sc-mt-4 sc-hidden">
