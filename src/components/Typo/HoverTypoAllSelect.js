...
<!-- Border width slider -->
<div id="typo-all-hover-border-width-track"
     class="sc-rounded-15px sc-relative sc-mt-2 sc-w-full sc-h-2 sc-bg-F6F6F6 sc-cursor-pointer"
     data-min="0" data-max="20" data-step="1">
  <div id="typo-all-hover-border-width-fill"
       class="sc-absolute sc-left-0 sc-top-0 sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"
       style="width:0px"></div>
  <div id="typo-all-hover-border-width-knob"
       class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
       style="left:0px; transform:translate(-50%,-50%);"></div>
</div>
