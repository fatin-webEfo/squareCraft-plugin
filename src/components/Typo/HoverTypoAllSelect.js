      ...
      <div id="typo-all-hover-font-section">
        ...
        <div  class="sc-mt-2 sc-relative sc-grid sc-grid-cols-12 sc-gap-8px">
          <div class="sc-col-span-7">
            ...
            <div id="hover-typo-allSelect-font-weight" class="sc-flex sc-z-999999 sc-bg-494949 sc-pl-2 sc-col-span-7 sc-mt-2 sc-cursor-pointer sc-justify-between sc-border sc-border-solid sc-border-585858 sc-rounded-4px sc-items-center">
              <div>
          ...
          <div id="hover-typo-allSelect-font-weight-list" class="sc-absolute  sc-w-150 sc-border sc-border-solid sc-border-EF7C2F sc-top-55px sc-hidden sc-z-999999 sc-scrollBar sc-max-h-140px sc-rounded-4px sc-bg-494949 sc-flex sc-flex-col sc-overflow-hidden">
            ...
            <div class="sc-flex sc-text-color-white sc-mt-2 sc-rounded-4px sc-relative sc-border sc-border-solid sc-border-585858 sc-items-center">
              <div class="sc-flex sc-text-color-white sc-justify-between sc-col-span-4 sc-rounded-4px sc-items-center">
                <div class="sc-font-size-container sc-roboto sc-universal sc-flex sc-justify-between sc-items-center sc-rounded-4px">
                  ...
                  <div id="hover-typo-allSelect-letter-spacing" class="sc-bg-3f3f3f sc-flex sc-items-center sc-justify-center sc-cursor-pointer sc-px-1_5 sc-tooltip-target" style="height: 28px;margin-left: 12px;border-radius: 0px 5px 5px 0px;">
                ...
                <div class="sc-absolute sc-hidden sc-scrollBar sc-z-99999 sc-border sc-border-solid sc-border-EF7C2F sc-h-44 sc-font-sm sc-bg-3f3f3f sc-w-12 sc-rounded-4px sc-border-585858 sc-mt-1">
                  ${LetterSpacing?.map(
                    (gap) =>
                      `<div class="sc-dropdown-item sc-py-1px sc-text-center sc-font-size-12" data-value="${gap}"> ${gap} </div>`
                  ).join("")}
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div id="typo-all-hover-border-section" class="sc-hidden sc-mt-2">
            ...
            <div id="typo-all-hover-border-width-track" class="sc-rounded-15px sc-relative sc-mt-2 sc-w-full sc-h-2 sc-bg-F6F6F6 sc-cursor-pointer" data-min="0" data-max="20" data-step="1">
              <div id="typo-all-hover-border-width-fill" class="sc-absolute sc-left-0 sc-top-0 sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full" style="width:0px"></div>
              <div id="typo-all-hover-border-width-knob" class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half" style="left:0px; transform:translate(-50%,-50%);"></div>
            </div>
