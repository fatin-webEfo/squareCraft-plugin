  ...
  return `
           ...
           <div class="sc-flex sc-text-color-white sc-items-center ">
              <div
                 ...
                 <div class="sc-font-size-container sc-poppins sc-universal sc-flex sc-justify-between sc-items-center sc-flex sc-items-center  
                       sc-rounded-4px 
                       ">
                    <input type="number" value="16" class="sc-font-size-input sc-font-light sc-z-99999 sc-text-sm sc-text-color-white 
                 ...
                 <div  class="sc-hidden  sc-h-44 sc-font-sm sc-bg-3f3f3f sc-w-20
        ...
        <div
           ...
           <div class="sc-col-span-5 sc-px-2 sc-bg-3f3f3f sc-inActiveTab-border sc-flex sc-justify-between sc-items-center  sc-rounded-4px">
              <p  class="sc-text-sm sc-poppins sc-universal">Select</p>
        ...
        <div
           ...
           <div
             ...
             <div
                 ...
                 <div data-align="left" class="sc-pt-1 sc-pb-1 sc-px-1_5 sc-inActiveTab-border sc-cursor-pointer sc-rounded-l">
   
                    <img 
                       src="https://goswami34.github.io/squareCraft-widget/public/alignment (4).svg"
                       class=" alignment-icon   sc-mx-auto" alt="left">
                 </div>
                  <div  data-align="center" class="sc-pt-1 sc-pb-1 sc-px-1_5 sc-inActiveTab-border sc-cursor-pointer ">
   
                    <img 
                       src="https://goswami34.github.io/squareCraft-widget/public/alignment (3).svg"
                       class=" alignment-icon   sc-mx-auto" alt="center">
                 </div>
                  <div data-align="right" class="sc-pt-1 sc-pb-1 sc-px-1_5 sc-inActiveTab-border sc-cursor-pointer">
   
                    <img 
                       src="https://goswami34.github.io/squareCraft-widget/public/alignment (2).svg"
                       class=" alignment-icon   sc-mx-auto" alt="right">
                 </div>
                 <div  data-align="justify" class="sc-pt-1 sc-pb-1 sc-px-1_5 sc-inActiveTab-border sc-cursor-pointer sc-rounded-r">
