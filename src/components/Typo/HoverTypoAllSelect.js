...
<div id="typo-all-hover-font-section">
   <div class="sc-flex sc-justify-between sc-items-center sc-mt-2">
           <p class=" sc-font-thin  sc-universal  sc-roboto"> Font  </p>
   ...
   <div  class="sc-mt-2 sc-relative sc-grid sc-grid-cols-12 sc-gap-8px">
     ...
     class="sc-absolute  sc-w-150 sc-border sc-border-solid sc-border-EF7C2F sc-top-55px sc-hidden sc-z-999999 sc-scrollBar sc-max-h-140px sc-rounded-4px sc-bg-494949 sc-flex sc-flex-col sc-overflow-hidden">
   ...
   <div>
     <div id="typo-all-hover-border-button" class="sc-mt-2 sc-relative sc-z-9999 sc-flex sc-border-hover-3d3d3d sc-border sc-border-solid sc-border-3f3f3f sc-cursor-pointer sc-px-2 sc-justify-between sc-py-1 sc-rounded-4px">
     ...
     <div id="typo-all-hover-border-section" class="sc-hidden sc-mt-2">
       ...
       <div class="sc-grid sc-grid-cols-12 sc-mt-2">
         ...
         <div style="padding: 2px 0px;" class="sc-bg-3f3f3f sc-flex sc-col-span-11 sc-font-size-12 sc-font-thin   sc-border sc-border-solid sc-border-3f3f3f   sc-justify-center  sc-px-1 sc-rounded-4px">
           <div class="sc-flex sc-px-1_5 sc-bg-3f3f3f sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1">
