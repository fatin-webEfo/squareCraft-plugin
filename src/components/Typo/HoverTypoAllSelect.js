...
<div id="typo-all-hover-font-section">
   ...
   <div  class="sc-mt-2 sc-relative sc-grid sc-grid-cols-12 sc-gap-8px">
     ...
     class="sc-absolute  sc-w-150 sc-border sc-border-solid sc-border-EF7C2F sc-top-10 sc-hidden sc-z-999999 sc-scrollBar sc-max-h-140px sc-rounded-4px sc-bg-494949 sc-flex sc-flex-col sc-overflow-hidden">
