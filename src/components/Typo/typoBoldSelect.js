export function typoBoldSelect(fontSizes) {
   ...
   <div
      class="sc-mt-2  sc-grid   sc-grid-cols-12 sc-gap-2 ">
       <div id="font-weight-dropdown" class="sc-flex sc-bg-494949 sc-relative sc-cursor-pointer sc-col-span-7 sc-justify-between sc-border sc-border-solid sc-border-585858 sc-rounded-6px sc-items-center">
        ...
        <div class="sc-px-2">
          <p class="sc-text-sm sc-universal sc-roboto sc-font-light">Regular</p>
        </div>
        ...
        <ol id="font-weight-dropdown-list" class="sc-absolute sc-hidden sc-top-10 sc-h-dropdown sc-w-full sc-bg-3f3f3f sc-border sc-border-solid sc-border-EF7C2F sc-rounded-6px sc-scrollBar sc-z-9999" style="list-style: none; padding: 0; margin: 0;">
   ...
   <div class="sc-mt-4 ">
      ...
      <div class="sc-py-1 sc-mt-2 sc-bg-3f3f3f sc-inActiveTab-border sc-w-50 sc-flex sc-justify-between sc-items-center sc-px-2 sc-rounded-6px">
         <p class="sc-text-sm sc-roboto sc-universal c-font-light">#363544</p>
