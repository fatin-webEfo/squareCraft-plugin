export function WidgetButtonNormalState() {
  ...
  <div id="color-code-dropdown-list"
       class="sc-absolute sc-border sc-border-solid sc-border-EF7C2F sc-left-0 sc-w-full sc-text-sm sc-top-0 sc-z-999999  sc-rounded-4px sc-bg-494949 sc-flex sc-hidden sc-top-6 sc-flex-col sc-overflow-hidden">
