                     ...
                     <div class="sc-tooltip sc-hidden">
                       ...
                       <div class="tooltip-arrow"></div>
                        Icon library
                           ...
                           <div id="buttonIconLibraryOptions" class="sc-absolute sc-hidden sc-p-1 sc-z-99999  sc-w-250 sc-border sc-border-solid sc-border-EF7C2F sc-rounded-md sc-top-12 sc-bg-color-3d3d3d  sc-left-0">
                            <div
                            style="
                              position: absolute;
                              top: -8px;
