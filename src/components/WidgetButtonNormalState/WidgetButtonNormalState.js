export function WidgetButtonNormalState() {
  ...
  <div id="color-code-dropdown-list"
       class="sc-absolute sc-border sc-border-solid sc-border-EF7C2F sc-left-0 sc-w-full sc-text-sm sc-top-0 sc-z-999999  sc-sc-rounded-15px sc-bg-494949 sc-flex sc-hidden sc-top-6 sc-flex-col sc-overflow-hidden">
    <div class="sc-cursor-pointer sc-dropdown-item sc-py-4px sc-px-2 " data-format="RGB">RGB</div>
    <div class="sc-cursor-pointer sc-dropdown-item sc-py-4px sc-px-2 " data-format="HSL">HSL</div>
    <div class="sc-cursor-pointer sc-dropdown-item sc-py-4px sc-px-2 " data-format="HEX">HEX</div>
  </div>
</div>
               ...
               <div id="bordersSection" class=" sc-mt-2 sc-hidden">
                  ...
                  <div class="sc-mt-4 sc-gap-2 sc-grid sc-grid-cols-12">
                     <div class="sc-col-span-5">
                        ...
                        <div
                           class="sc-py-0_5 sc-relative sc-mt-2 sc-bg-3f3f3f sc-inActiveTab-border  sc-flex sc-justify-between sc-items-center sc-px-1 sc-rounded-4px">
