...
export function WidgetButtonNormalState(){
   ...
   <div id="ButtonNormalState" class="sc-mt-4 sc-px-2">
         ...
         <div class="sc-mt-2 sc-relative sc-grid sc-grid-cols-12 sc-gap-2 ">
            ...
            <div id="scButtonFontWeightOptions" class="sc-absolute sc-w-140px sc-border sc-border-solid sc-border-EF7C2F sc-hidden sc-top-10 sc-z-99999 sc-scrollBar sc-h-dropdown sc-rounded-6px sc-bg-494949 sc-flex sc-flex-col sc-overflow-hidden">
