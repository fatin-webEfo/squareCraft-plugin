            ...
            <div id="image-hover-filter-section">
               <div class="sc-mt-3">
                  <div class="  sc-flex sc-items-center sc-justify-between">
                     <div class="sc-flex sc-gap-2 sc-items-center">
                        ...
                        <div id="image-hover-filter-blur-reset"
                           class="sc-flex sc-cursor-pointer sc-gradiant-border sc-items-center sc-rounded-15px sc-gap-1 sc-p-1_5  sc-bg sc-bg-454545">
                     ...
                     <div
                        class="sc-flex sc-cursor-pointer sc-items-center sc-rounded-15px sc-gap-2 sc-px-2 sc-py-0_5 sc-bg sc-bg-454545">
                        <p id="image-hover-filter-blur-Count" class="sc-font-thin sc-roboto sc-universal sc-font-size-11">0px</p>
                        <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                            <span  id="image-hover-filter-blur-Increase" class="sc-arrow-placeholder"></span>
                            <span id="image-hover-filter-blur-Decrease" class="sc-arrow-placeholder sc-rotate-180"></span>
                        </div>
                     </div>
                  </div>
                 <div id="image-hover-filter-blur-Field" class="sc-rounded-15px sc-mt-2 sc-relative sc-w-full sc-h-2 sc-bg-F6F6F6">
                <div id="image-hover-filter-blur-Fill" class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"></div>
                <div id="image-hover-filter-blur-Bullet"
                    class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half">
                </div>
                </div>
               </div>
               <div class="sc-mt-3">
                  <div class="  sc-flex sc-items-center sc-justify-between">
                     ...
                     <div
                        class="sc-flex sc-cursor-pointer sc-items-center sc-rounded-15px sc-gap-2 sc-px-2 sc-py-0_5 sc-bg sc-bg-454545">
                        <p id="image-hover-filter-brightness-BorderradiusCount" class="sc-font-thin sc-roboto sc-universal sc-font-size-11">0px</p>
                        <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                            <span  id="image-hover-filter-brightness-BorderradiusIncrease" class="sc-arrow-placeholder"></span>
                            <span id="image-hover-filter-brightness-BorderradiusDecrease" class="sc-arrow-placeholder sc-rotate-180"></span>
                        </div>
                     </div>
                  </div>
                 <div id="image-hover-filter-brightness-BorderradiusField" class="sc-rounded-15px sc-mt-2 sc-relative sc-w-full sc-h-2 sc-bg-F6F6F6">
                <div id="image-hover-filter-brightness-BorderradiusFill" class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"></div>
                <div id="image-hover-filter-brightness-BorderradiusBullet"
                    class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half">
                </div>
                </div>
               </div>
               <div class="sc-mt-3">
                  <div class="  sc-flex sc-items-center sc-justify-between">
                     ...
                     <div
                        class="sc-flex sc-cursor-pointer sc-items-center sc-rounded-15px sc-gap-2 sc-px-2 sc-py-0_5 sc-bg sc-bg-454545">
                        <p id="image-hover-filter-contrast-BorderradiusCount" class="sc-font-thin sc-roboto sc-universal sc-font-size-11">0px</p>
                        <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                            <span  id="image-hover-filter-contrast-BorderradiusIncrease" class="sc-arrow-placeholder"></span>
                            <span id="image-hover-filter-contrast-BorderradiusDecrease" class="sc-arrow-placeholder sc-rotate-180"></span>
                        </div>
                     </div>
                  </div>
                 <div id="image-hover-filter-contrast-BorderradiusField" class="sc-rounded-15px sc-mt-2 sc-relative sc-w-full sc-h-2 sc-bg-F6F6F6">
                <div id="image-hover-filter-contrast-BorderradiusFill" class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"></div>
                <div id="image-hover-filter-contrast-BorderradiusBullet"
                    class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half">
                </div>
                </div>
               </div>
               <div class="sc-mt-3">
                  <div class="  sc-flex sc-items-center sc-justify-between">
                     ...
                     <div
                        class="sc-flex sc-cursor-pointer sc-items-center sc-rounded-15px sc-gap-2 sc-px-2 sc-py-0_5 sc-bg sc-bg-454545">
                        <p id="image-hover-filter-saturation-BorderradiusCount" class="sc-font-thin sc-roboto sc-universal sc-font-size-11">0px</p>
                        <div class="sc-flex sc-flex-col sc-items-center sc-gap-1">
                            <span  id="image-hover-filter-saturation-BorderradiusIncrease" class="sc-arrow-placeholder"></span>
                            <span id="image-hover-filter-saturation-BorderradiusDecrease" class="sc-arrow-placeholder sc-rotate-180"></span>
                        </div>
                     </div>
                  </div>
                 <div id="image-hover-filter-saturation-BorderradiusField" class="sc-rounded-15px sc-mt-2 sc-relative sc-w-full sc-h-2 sc-bg-F6F6F6">
                <div id="image-hover-filter-saturation-BorderradiusFill" class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"></div>
                <div id="image-hover-filter-saturation-BorderradiusBullet"
                    class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half">
                </div>
                </div>
               </div>
