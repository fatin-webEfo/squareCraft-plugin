          ...
          <div id="buttonSection">
            ...
            <div class="sc-mt-4 sc-px-2">
               ...
               <div class="sc-mt-2  sc-grid sc-grid-cols-12 sc-gap-2 ">
                  ...
                  <div
                     class="sc-col-span-5 sc-px-2 sc-bg-3f3f3f sc-inActiveTab-border sc-flex sc-justify-between sc-items-center  sc-rounded-6px">
            ...
            sc-items-center ">
               ...
               <div class="sc-mt-4 ">
                  ...
                  <div
                     class="sc-py-1 sc-mt-2 sc-w-30 sc-bg-3f3f3f sc-inActiveTab-border  sc-flex sc-justify-between sc-items-center sc-px-2 sc-rounded-6px">
                  ...
                  <div class="sc-flex sc-items-center sc-gap-2">
                     ...
                     <div>
                        ...
                        <div class="sc-flex sc-mt-2 sc-items-center">
                           <div class="sc-bg-3f3f3f sc-py-1 sc-rounded-l sc-px-2 sc-w-16">
                           ...
                           <div style="padding-top: 7px; padding-bottom: 7px;" class="sc-bg-454545 sc-px-2_5 ">
                              <div class="sc-flex sc-flex-col sc-items-center sc-gap-2">
                                 ...
                                 <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg"
                                    width="10" class="sc-rotate-180" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div>
                     ...
                     <div class="sc-flex sc-mt-2 sc-items-center">
                        <div class="sc-bg-3f3f3f sc-py-1 sc-rounded-l sc-px-2 ">
                           <p class="sc-universal sc-roboto sc-text-sm ">35 deg</p>
                        </div>
                        <div style="padding-top: 7px; padding-bottom: 7px;" class="sc-bg-454545 sc-px-2_5 ">
                           <div class="sc-flex sc-flex-col sc-items-center sc-gap-2">
                              <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" alt=""
               ...
               <div>
                  ...
                  <div id="borderSection" class=" sc-mt-3">
               ...
               <div
                  ...
                  <div class="sc-flex sc-mt-8 sc-justify-between sc-gap-2 sc-items-center">
                     <p style="font-size: 16px;" class="sc-roboto sc-font-thin sc-universal  sc-text-color-white">Button Styles</p>
                     <div
                        class="sc-flex sc-cursor-pointer sc-items-center sc-rounded-15px sc-gap-1 sc-p-1_5  sc-bg sc-bg-454545">
