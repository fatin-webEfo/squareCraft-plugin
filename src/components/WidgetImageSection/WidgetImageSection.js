               ...
               <div class="sc-mt-4 sc-gap-2 sc-grid sc-grid-cols-12">
                  <div class="sc-col-span-5">
                     ...
                     <div
                        ...
                        <div id="selected-color-view" class="sc-square-6 sc-border-colors sc-cursor-pointer"></div>
                        ...
                        <div id="color-palette"
                           ...
                           <div
                              ...
                              <p id="selected-color-code" class="sc-text-sm sc-poppins sc-font-light sc-universal">#363544</p>
                              <p id="color-selection-opacity" class="sc-text-sm sc-poppins sc-font-light sc-universal">100%</p>
                           </div>
                        </div>
