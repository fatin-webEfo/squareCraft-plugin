export function WidgetImageSection(id) {
  return `
   ...
   <span class="sc-arrow-placeholder sc-rotate-180"></span>
                      ...
                      <div style="padding: 2px 0px; margin-top: 10px; margin-left: 98px;"
                         class="sc-bg-3f3f3f sc-flex sc-gap-1 sc-text-sm sc-font-thin   sc-border sc-border-solid sc-border-3f3f3f   sc-justify-center  sc-px-1 sc-rounded-4px">
 
   
 
                         <div
                            class="sc-flex sc-justify-center  sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1 sc-px-2 sc-bg-454545"  id="allradiusBorder">
                            <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/all.svg" loading="lazy"
                               alt="all-radious">
                            <p class="sc-font-thin sc-roboto sc-universal">All</p>
                         </div>
                         ...
                         <div
                            class="sc-flex sc-justify-center  sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1 sc-px-2" id="topLeftradiusBorder">
                         ...
                         <div
                            class="sc-flex sc-justify-center  sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1 sc-px-2" id="topRightradiusBorder">
                         ...
                         <div
                            class="sc-flex sc-justify-center  sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1 sc-px-2" id="bottomRightradiusBorder">
                         ...
                         <div
                            class="sc-flex sc-justify-center  sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1 sc-px-2" id="bottomLeftradiusBorder">
                ...
                <div id="overLaySection" class="sc-px-2 sc-hidden sc-mt-3">
                   ...
                   <div class="sc-flex sc-mt-2 sc-items-center">
                      ...
                      <div class="sc-bg-454545 sc-flex sc-items-center sc-justify-center sc-px-2_5 sc-py-5"><span  class="sc-arrow-placeholder sc-rotate-180"></span></div>
                   </div>
