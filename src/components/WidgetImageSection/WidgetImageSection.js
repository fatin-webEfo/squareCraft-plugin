                ...
                <div id="borderSection" class="sc-px-2 sc-mt-3">
                   ...
                   <div class="sc-mt-3">
                      ...
                      <div style="padding: 2px 0px; margin-top: 10px; margin-left: 65px;"
                         ...
                         <div
                            class="sc-flex sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1 sc-bg-454545"  id="allradiusBorder">
                            <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/all.svg" loading="lazy"
                               alt="all-radious">
                            <p class="sc-font-thin sc-roboto sc-universal">All</p>
                         </div>
                         ...
                         <div
                            class="sc-flex sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1" id="topLeftradiusBorder">
                         ...
                         <div
                            class="sc-flex sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1" id="topRightradiusBorder">
                         ...
                         <div
                            class="sc-flex sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px  sc-items-center sc-gap-1" id="bottomLeftradiusBorder">
