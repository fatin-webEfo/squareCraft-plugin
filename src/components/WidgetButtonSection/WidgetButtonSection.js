            ...
            <div class="">
               <div class="sc-flex sc-items-center sc-gap-2">
                  ...
                  <div class="sc-flex sc-mt-2 sc-relative sc-items-center">
                     ...
                     <div id="iconPositionDropdown" class="sc-absolute sc-hidden sc-left-0 sc-top-[35px] sc-z-50">
                       <div class="sc-bg-3f3f3f sc-py-1 sc-px-2 sc-w-16 sc-cursor-pointer" data-value="before">Before</div>
                       <div class="sc-bg-3f3f3f sc-py-1 sc-px-2 sc-w-16 sc-cursor-pointer" data-value="after">After</div>
                     </div>
                   
                     <div id="buttoniconPositionSection" class="sc-bg-454545 sc-cursor-pointer sc-px-2_5 sc-py-[7px]">
