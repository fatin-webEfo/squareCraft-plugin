               ...
               <div class="sc-flex sc-items-center sc-gap-2">
                  ...
                  <div>
                     ...
                     <div class="sc-flex sc-mt-2 sc-relative sc-items-center">
                        <div data-value="before"  class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-2 sc-w-16">
                           <p class="sc-universal sc-roboto sc-text-sm ">Before</p>

                        </div>   
                           <div data-value="after" style="top: 35px;" id="" class="sc-absolute sc-hidden sc-left-0 "> 
                              <div  class="sc-bg-3f3f3f sc-relative sc-py-1 sc-px-2 sc-w-16">
                              <p class="sc-universal sc-roboto sc-text-sm ">After</p>
   
                           </div>
                        </div>
                        <div id="buttoniconPositionSection" style="padding-top: 7px; padding-bottom: 7px;" class="sc-bg-454545 sc-cursor-pointer sc-px-2_5 ">
