 ...
 <div id="buttonSection">
         ...
         <div class="sc-flex sc-col-span-6 sc-justify-between  sc-items-center ">
               ...
               <div class="sc-mt-4 sc-flex sc-items-center sc-gap-2">
                  <div>
                     <p class="sc-roboto sc-universal sc-text-sm sc-font-light sc-text-gray-300">Rotation</p>
                     <div class="sc-flex sc-mt-2 sc-items-center sc-relative">
                        <div id="buttoniconRotationValue" class="sc-bg-3f3f3f sc-py-1 sc-rounded-l sc-px-2 ">
                           <p id="buttoniconRotationCurrentValue" class="sc-universal sc-roboto sc-text-sm ">0 deg</p>
                        </div>
                        <div id="buttoniconRotationDropdown"></div>
                        <div id="buttoniconRotationSection" style="padding-top: 7px; padding-bottom: 7px;" class="sc-bg-454545 sc-px-2_5 ">
                           <div class="sc-flex sc-flex-col sc-cursor-pointer sc-items-center sc-gap-2">
                              <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" alt=""
                                 width="10">
                  ...
                  <div>
                     ...
                     <div id="buttoniconWidthSelect" style="padding-top: 7px; padding-bottom: 7px;" class="sc-bg-454545 sc-cursor-pointer sc-px-2_5">
                        <div class="sc-flex sc-flex-col sc-items-center sc-gap-2">
                           <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" alt="" width="10" />
                           <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" width="10" class="sc-rotate-180" alt="" />
                        </div>
                     </div>
                     </div>
                  ...
                  <div>
                     ...
                     <div id="buttoniconHeightSelect" style="padding-top: 7px; padding-bottom: 7px;" class="sc-bg-454545 sc-cursor-pointer sc-px-2_5">
                        <div class="sc-flex sc-flex-col sc-items-center sc-gap-2">
                           <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" alt="" width="10" />
                           <img src="https://fatin-webefo.github.io/squareCraft-plugin/public/arrow.svg" width="10" class="sc-rotate-180" alt="" />
                        </div>
               ...
               <div class="sc-grid sc-grid-cols-12 sc-mt-3">
                  ...
                  <div style="padding: 2px 0px;"
                     ...
                     <div id="buttonIconSpacingTop" data-value="buttonIconSpacingTop"
                        class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-0_5 sc-rounded-6px sc-bg-454545 sc-rounded-6px  sc-items-center sc-gap-1">
                     ...
                     <div id="buttonIconSpacingBottom" data-value="buttonIconSpacingBottom"
                     ...
                     <div id="buttonIconSpacingLeft" data-value="buttonIconSpacingLeft"
                        class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-0_5 sc-rounded-6px  sc-items-center sc-gap-1">
                     ...
                     <div id="buttonIconSpacingRight" data-value="buttonIconSpacingRight"
