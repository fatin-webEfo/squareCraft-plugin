...
function initHoverTypoAllBorderControls(getSelectedElement) {
  const sideElements = [
    ...
    document.getElementById("typo-all-hover-border-side-bottom"),
    document.getElementById("typo-all-hover-border-side-left"),
    document.getElementById("typo-all-hover-border-side-right"),
  ];
