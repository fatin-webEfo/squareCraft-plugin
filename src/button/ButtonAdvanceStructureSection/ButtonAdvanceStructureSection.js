  ...
  <div
    id="button-advance-structure-button"
  ...
  <div id="button-advance-structure-section">
    <div class="sc-mt-2">
      <p
        class="sc-universal sc-roboto sc-text-gray-300 sc-text-sm sc-font-thin"
      >
        Adjust button margin and padding with individual or global controls.
      </p>
    </div>
    ...
    <div class="sc-flex sc-mt-2 sc-items-center sc-justify-between">
      ...
      <div id="button-advance-structure-reset-all"
      ...
      >
        ...
        >
          <div class="button-structure-margin-top-box">
            <div
              ...
              class="button-structure-margin-top-fill"
            ></div>
          </div>
        </div>
        <div class="sc-flex sc-items-center sc-justify-center sc-gap-2">
          ...
          >
            <div class="button-structure-margin-left-box">
              <div
                ...
                class="button-structure-margin-left-fill"
              ></div>
            </div>
          </div>

          <div class="button-structure-allside-box sc-relative sc-bg-454545">
            <img
          ...
          >
            ...
            <div
              ...
              class="button-structure-padding-left sc-absolute sc-cursor-pointer"
              style="left: 2px"
            ></div>
            <div
              id="button-structure-padding-right"
              class="button-structure-padding-right sc-absolute sc-cursor-pointer"
              style="right: 2px"
            ></div>
            <div
              id="button-structure-padding-top"
              class="button-structure-padding-top sc-absolute sc-cursor-pointer"
              style="top: 2px"
            ></div>
            <div
              id="button-structure-padding-bottom"
              class="button-structure-padding-bottom sc-absolute sc-cursor-pointer"
              style="bottom: 2px"
            ></div>
          </div>
          ...
          <div class="sc-flex sc-items-center sc-justify-center sc-relative">
            <div class="button-structure-margin-right-box">
              <div
                id="button-structure-margin-right-fill"
        ...
        <div class="sc-relative sc-items-center sc-flex-col">
          <div class="button-structure-margin-bottom-box">
            <div
              id="button-structure-margin-bottom-fill"
      ...
      <div class="sc-mt-4">
        <div>
          <div class="sc-flex sc-items-center sc-justify-between">
            ...
            <div class="sc-flex sc-items-center sc-gap-3">
              <div id="button-advance-margin-reset"
        ...
        <div id="button-advance-marginTop">
          ...
          <div class="sc-grid sc-grid-cols-12 sc-mt-2">
            ...
            >
              <div
                id="button-advance-margin-gap-all"
              ...
              <div
                id="button-advance-margin-gap-top"
              ...
              <div
                id="button-advance-margin-gap-bottom"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
              ...
              <div
                id="button-advance-margin-gap-left"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
              ...
              <div
                id="button-advance-margin-gap-right"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
      ...
      <div class="sc-mt-4">
        <div>
          <div class="sc-flex sc-items-center sc-justify-between">
            ...
            <div class="sc-flex sc-items-center sc-gap-3">
              <div id="button-advance-padding-reset"
                class="sc-flex sc-cursor-pointer sc-gradiant-border sc-items-center sc-rounded-15px sc-gap-1 sc-p-1_5 sc-bg-3f3f3f"
              >
                <img
                  src="https://fatin-webefo.github.io/squareCraft-plugin/public/reset.svg"
        ...
        <div id="button-advance-paddingTop">
          <div
            class="sc-rounded-15px sc-relative sc-mt-2 sc-w-full sc-h-2 sc-bg-F6F6F6"
          >
            <div id="button-advance-padding-gap-fill"
              class="sc-absolute sc-bg-color-EF7C2F sc-h-2 sc-rounded-l-full"
              style="width: 0%"
            ></div>
            <div id="button-advance-padding-gap-bullet"
              class="sc-absolute sc-bg-color-EF7C2F sc-w-3 sc-h-3 sc-rounded-full sc-cursor-pointer sc-top-half"
              style="left: 0%"
            ></div>
          </div>
          <div class="sc-grid sc-grid-cols-12 sc-mt-2">
            ...
            >
              <div
                id="button-advance-padding-gap-all"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-bg-454545 sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
                  src="https://fatin-webefo.github.io/squareCraft-plugin/public/all.svg"
              ...
              <div
                id="button-advance-padding-gap-top"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
                  src="https://fatin-webefo.github.io/squareCraft-plugin/public/top.svg"
              ...
              <div
                id="button-advance-padding-gap-bottom"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
                  src="https://fatin-webefo.github.io/squareCraft-plugin/public/bottom.svg"
              ...
              <div
                id="button-advance-padding-gap-left"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
                  src="https://fatin-webefo.github.io/squareCraft-plugin/public/left.svg"
              ...
              <div
                id="button-advance-padding-gap-right"
                class="sc-flex sc-px-1_5 sc-justify-center sc-w-full sc-cursor-pointer sc-py-4px sc-rounded-4px sc-items-center sc-gap-1"
              >
                <img
                  src="https://fatin-webefo.github.io/squareCraft-plugin/public/right.svg"
