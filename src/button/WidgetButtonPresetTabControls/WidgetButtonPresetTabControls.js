export function WidgetButtonPresetTabControls() {
  const buttonIds = ["button-my-preset-tab", "button-preset-library-tab"];
  const sectionIds = [
    "button-my-preset-section",
    "button-preset-library-section",
  ];
