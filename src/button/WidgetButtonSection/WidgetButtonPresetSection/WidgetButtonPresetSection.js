  ...
  return `
    <div id="presetSection" class="sc-p-4 sc-flex-col sc-gap-4 sc-rounded-2xl sc-bg-1e1e1e sc-text-white sc-shadow-md sc-text-sm">
      ...
      <div class="sc-grid sc-grid-cols-2 sc-gap-4" id="presetGrid">
        <div class="preset-card sc-bg-2a2a2a sc-rounded-xl sc-p-3 sc-flex-col sc-gap-2 sc-border sc-border-333333 hover:sc-border-EF7C2F sc-transition-all sc-cursor-pointer" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="preset-card sc-bg-2a2a2a sc-rounded-xl sc-p-3 sc-flex-col sc-gap-2 sc-border sc-border-333333 hover:sc-border-EF7C2F sc-transition-all sc-cursor-pointer" data-aos="fade-up" data-aos-delay="100">
          <div class="sc-rounded-lg sc-overflow-hidden sc-bg-black sc-border sc-border-262626" style="width: 100%; height: 160px;">
        ...
        <div class="preset-card sc-bg-2a2a2a sc-rounded-xl sc-p-3 sc-flex-col sc-gap-2 sc-border sc-border-333333 hover:sc-border-EF7C2F sc-transition-all sc-cursor-pointer" data-aos="fade-up" data-aos-delay="200">
          <div class="sc-rounded-lg sc-overflow-hidden sc-bg-black sc-border sc-border-262626" style="width: 100%; height: 160px;">
        ...
        <div class="preset-card sc-bg-2a2a2a sc-rounded-xl sc-p-3 sc-flex-col sc-gap-2 sc-border sc-border-333333 hover:sc-border-EF7C2F sc-transition-all sc-cursor-pointer" data-aos="fade-up" data-aos-delay="300">
          <div class="sc-rounded-lg sc-overflow-hidden sc-bg-black sc-border sc-border-262626" style="width: 100%; height: 160px;">
