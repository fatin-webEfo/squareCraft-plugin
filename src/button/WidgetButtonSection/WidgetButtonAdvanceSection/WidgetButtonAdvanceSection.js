export function WidgetButtonAdvanceSection(){
          ...
          >
            <div class="sc-flex sc-flex-col sc-gap-2">
              ...
              <div
               ...
               <div id="custom-timeline-border" class="sc-mt-1 sc-relative sc-roboto sc-border-t sc-border-t-dashed sc-border-color-707070 sc-w-full">
               <div id="custom-timeline-arrow" class="sc-custom-timeline-arrow sc-absolute sc-top-6px"></div>
               </div>
            </div>
    ...
    <div class="sc-flex sc-mt-2 sc-z-[99999] sc-relative sc-items-center">
      <div  class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-1 sc-w-25px">
      <p  class="sc-universal sc-roboto sc-font-size-12 sc-font-light">10 px</p>
      </div>   
      <div  class="sc-bg-454545 sc-cursor-pointer sc-px-2_5 sc-py-0_5px">
      <div class="sc-flex sc-flex-col sc-items-center sc-gap-2">
         <span class="sc-arrow-placeholder"></span>
  ...
  <div>
    <p class="sc-universal sc-font-size-12 sc-font-light sc-text-gray-300">Right</p>
    <div class="sc-flex sc-mt-2 sc-z-[99999] sc-relative sc-items-center">
      <div  class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-1 sc-w-25px">
      <p  class="sc-universal sc-roboto sc-font-size-12 sc-font-light">10 px</p>
      </div>   
  ...
  <div>
    <p class="sc-universal sc-font-size-12 sc-font-light sc-text-gray-300">Bottom</p>
    <div class="sc-flex sc-mt-2 sc-z-[99999] sc-relative sc-items-center">
      <div  class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-1 sc-w-25px">
      <p  class="sc-universal sc-roboto sc-font-size-12 sc-font-light">10 px</p>
      </div>   
  ...
  <div>
    <p class="sc-universal sc-font-size-12 sc-font-light sc-text-gray-300">Left</p>
    <div class="sc-flex sc-mt-2 sc-z-[99999] sc-relative sc-items-center">
      <div  class="sc-bg-3f3f3f sc-relative sc-py-1 sc-rounded-l sc-px-1 sc-w-25px">
      <p  class="sc-universal sc-roboto sc-font-size-12 sc-font-light">10 px</p>
      </div>   
