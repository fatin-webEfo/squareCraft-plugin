export function WidgetButtonAdvanceSection(){
  ...
  <div id="button-advance-section">
               ...
               <div id="button-advance-structure" class="sc-p-2">
                ...
                <div class="sc-mt-2"> <p class="sc-universal sc-roboto sc-text-gray-300 sc-text-sm sc-font-thin" >Adjust button margin and padding with individual or global controls. </p></div>
              ...
              <div id="button-advance-scrollEffects" class="sc-px-2 sc-mt-4">
