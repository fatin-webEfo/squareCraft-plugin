export function NavbarIconHtml() {
  ...
  <div style="padding: 12px 16px; color: white; font-size: 14px; display: flex; align-items: center; justify-content: space-between;">
    ...
    <div id="viewport-sections" style="cursor: pointer; display: flex; align-items: center; gap: 8px; justify-content: center;">
      <img class="mobile-viewport" src="https://fatin-webefo.github.io/squareCraft-plugin/public/viewport/mobile.svg" style="width: 18px;">
      <img class="tab-viewport" src="https://fatin-webefo.github.io/squareCraft-plugin/public/viewport/tab.svg" style="width: 18px;">
      <img class="laptop-viewport" src="https://fatin-webefo.github.io/squareCraft-plugin/public/viewport/laptop.svg" style="width: 18px;">
      <img class="dekstop-viewport" src="https://fatin-webefo.github.io/squareCraft-plugin/public/viewport/monitor.svg" style="width: 18px;">
    </div>
  </div>
