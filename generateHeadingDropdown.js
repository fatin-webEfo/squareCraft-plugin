  ...
  return `
    <div id="${id}">
      ...
      <div class="sc-mt-5 sc-px-2">
        ...
        <div class="sc-text-xs sc-text-gray-400 sc-mt-1" id="scDesc-${id}-allSelect">All text part</div>
        <div class="sc-text-xs sc-text-gray-400 sc-mt-1 sc-hidden" id="scDesc-${id}-boldSelect">Bold text part</div>
