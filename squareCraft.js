...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", () => {
    requestAnimationFrame(() => {
      if (typeof injectNavbarIconFn === "function" && !window.__squareCraftResetFlags.get("navIconDOM")) {
        injectNavbarIconFn();
  ...
  requestAnimationFrame(() => {
    if (typeof injectNavbarIconFn === "function" && !window.__squareCraftResetFlags.get("navIconRAF")) {
      injectNavbarIconFn();
...
// throttle this observer to avoid firing on every tiny DOM change
const observer = new MutationObserver(() => {
  observer.disconnect();
...
async function loadWidgetFromString(htmlString, clickedBlock) {
 ...
 function makeWidgetDraggable() {
  ...
  initHoverTypoTabControls([
    { buttonId: "typo-all-hover-font-button", sectionId: "typo-all-hover-font-section" },
    { buttonId: "typo-all-hover-border-button", sectionId: "typo-all-hover-border-section" },
    { buttonId: "typo-all-hover-shadow-button", sectionId: "typo-all-hover-shadow-section" },
    { buttonId: "typo-all-hover-effects-button", sectionId: "typo-all-hover-effects-section" },
    { buttonId: "typo-bold-hover-font-button", sectionId: "typo-bold-hover-font-section" },
    { buttonId: "typo-italic-hover-font-button", sectionId: "typo-italic-hover-font-section" },
    { buttonId: "typo-link-hover-font-button", sectionId: "typo-link-hover-font-section" },
  ]);
  initHoverButtonSectionToggleControls();
